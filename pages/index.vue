...
main
  ...
  section.section-problem
    .content
      h2 Contract collaboration shouldn’t be this f*cked
      .hero-mail.-mobile
        header.header
  ...
  section.section-solution
    ...
    .content
      h1.title Tame your Microsoft Word™️ documents version <span class="-strikethrough">dis</span>control
      .branding.-mobile
        img(src="../assets/logo_onefinaldoc.svg")
  ...
  section.section-newsletter
    ...
    <SubmitEmail />
    p Already a customer? <a href="">Sign in</a>
